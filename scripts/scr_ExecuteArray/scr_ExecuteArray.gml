function scr_ExecuteArray(argument0, argument1) {
	// @desc execute script with argument array
	/// @returns any
	/// @arg script
	/// @arg args[]

	// This allows us to execute array of scripts from "script_execute" where without it, function only executes a lot of arguments but not an array
